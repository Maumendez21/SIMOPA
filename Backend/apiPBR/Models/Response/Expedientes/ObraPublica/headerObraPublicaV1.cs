...
{
    public class headerObraPublicaV1:BasicResponse
    {
        public List<headerCardObraPublicaV1> headerObraPublicaV1s = new List<headerCardObraPublicaV1>();
    }
    public class headerCardObraPublicaV1
    {
